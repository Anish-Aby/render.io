import BlogContentCalltoActionDivider from "./BlogContentCallToActionDivider";
import BlogMainBody from "./BlogMainBody";
import BlogMainImage from "./BlogMainImage";
import BlogUserStatBar from "./BlogUserStatBar";
...
export default function BlogContent() {
  return (
    <div className="blog-content-main-container">
      ...
      <div className="blog-subheading">{blog.subHeading}</div>
      <BlogUserStatBar
        name={blog.name}
        date={blog.date}
        readTime={blog.readTime}
      />
      <BlogContentCalltoActionDivider
        likes={blog.likes}
        comments={blog.comments}
      />
      <BlogMainImage blogImage={blog.blogImage} />
      <BlogMainBody blogBody={blog.body} />
    </div>
  );
}
