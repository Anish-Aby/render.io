...
export default function FeedAside() {
  return (
    <div className="hidden border-l w-1/4 max-w-sm xl:flex justify-center font-p1">
      <div className="mt-10 w-4/5 flex flex-col gap-5">
        <div className="flex flex-col gap-4">
          ...
          <p>
            Basic interactivity (liking, commenting, and saving) will be roled
            out.
          </p>
          <p>
            In the coming days, users will be able to create accounts and post
            blogs.
          </p>
