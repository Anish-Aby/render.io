export default function GradientAccent() {
  return (
    <div className="absolute -top-5 left-0 w-full h-1/2 -z-10 flex justify-center blur-2xl opacity-60 lg:h-svh overflow-hidden md:-translate-y-1/4 lg:-translate-y-1/3 xl:-translate-y-2/5 2xl:-translate-y-2/5">
